...
sheet <- read.csv("lowerpart.csv", header = FALSE)
idxRef <- read.csv("chromium_sample_indexes.csv", header = FALSE)
...
write.table(x = sheet, file = "lower_new.csv",  row.names = FALSE, col.names = FALSE)
